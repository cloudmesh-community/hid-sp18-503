...
of the networking issues~\cite{bmc-app-centric}. An application centric
...
authentication using Milagro MFA, secure communications and maintain
ledgers for security~\cite{milagro-docs-overview}.
